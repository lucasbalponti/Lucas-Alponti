...
| [ Otimização de modelos através de hiperparâmetros](https://github.com/lucasbalponti/otimizacao-de-modelos-ml-atraves-de-hiperparametros) | Neste projeto foram realizados estudos sobre a otimização de modelos através de hiperparâmetros, overfitting, utilização do grid search CV para a otimização e o conceito de validações cruzadas aninhadas. |
